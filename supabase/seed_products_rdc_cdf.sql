...
insert into public.products (name, price, category, image_url, available) values
  ...
  ('Viande frite', 6500, 'condiments', 'https://images.unsplash.com/photo-1600891964092-4316c288032e?w=800&q=80&auto=format', true),
  ...
  ('Nsaka', 4000, 'legumes', 'https://images.unsplash.com/photo-1540420773420-3366772f4999?w=800&q=80&auto=format', true),
